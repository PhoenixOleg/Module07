...
namespace Module07
{
    ...
    class HomeDelivery : Delivery
    {
        ...
        internal override void ShowSendingResume() 
        {
    ...
    class ShopDelivery : PickPointDelivery
    {
        ...
        internal override void ShowSendingResume() //Если создам экземпляр как PickPointDelivery shopDelivery = new ShopDelivery и метод будет new вместо override (сокрыт, а не переопределен), будет выдача со склада
        {
